          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between space-x-2">
              <Label htmlFor="dark-mode" className="flex flex-col gap-1">
                ...
                <span className="font-normal text-zinc-600">Force dark appearance for all users.</span>
              </Label>
              <Switch id="dark-mode" />
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-2">
              ...
              <div className="flex items-center gap-4">
                <div className="h-16 w-16 rounded-lg bg-zinc-100 flex items-center justify-center text-zinc-600 border border-dashed border-zinc-200">
            ...
            <div className="grid gap-2">
              ...
              <div className="h-24 w-full rounded-lg bg-zinc-100 flex items-center justify-center text-zinc-600 border border-dashed border-zinc-200">
                 <p className="text-zinc-600">Recommended: 1920x400px</p>
              </div>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between space-x-2">
              <Label htmlFor="remove-branding" className="flex flex-col gap-1">
                ...
                <span className="font-normal text-zinc-600">Hides attribution in footer and emails.</span>
              </Label>
            ...
            <div className="flex items-center justify-between space-x-2">
              <Label htmlFor="custom-domain" className="flex flex-col gap-1">
                ...
                <span className="font-normal text-zinc-600">Connect quiz.yourcenter.com</span>
              </Label>
