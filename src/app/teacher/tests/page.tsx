...
export default function TeacherTestsPage() {
  ...
  if (loading) return <div className="p-8 text-zinc-600 animate-pulse">Loading tests...</div>;
  if (error) return <div className="p-8 text-zinc-600">Error: {error}</div>;

  return (
    <div className="space-y-6">
       <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold tracking-tight">Manage Tests</h1>
            <p className="text-zinc-600">Create and publish assessments for your students.</p>
          </div>
       ...
       <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          {tests.length === 0 && (
              <div className="col-span-full p-8 text-zinc-600 border-2 border-dashed rounded-lg text-zinc-600">
