  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700 pb-20 p-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-black tracking-tighter uppercase">Growth Matrix</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <Card className="lg:col-span-8 border shadow-md rounded-2xl overflow-hidden bg-white dark:bg-zinc-950">
           <CardHeader className="p-6 border-b bg-zinc-50/50 dark:bg-zinc-900/30">
              <div className="flex justify-between items-center">
                 <div>
                    <CardTitle className="text-xl font-black uppercase tracking-tighter">Performance Velocity</CardTitle>
        ...
        <Card className="lg:col-span-4 border shadow-md rounded-2xl bg-zinc-900 text-white p-6 overflow-hidden relative">
           <div className="relative z-10 h-full flex flex-col">
              <h3 className="text-xl font-black uppercase tracking-tighter mb-2">Aptitude Radar</h3>
              ...
              {data && (
                 <div className="mt-8 space-y-4">
                    <div className="flex justify-between items-end border-b border-white/5 pb-2">
                       ...
                       <span className="text-sm font-black text-emerald-500">{data.overview.strongest_subject}</span>
                    </div>
                    <div className="flex justify-between items-end border-b border-white/5 pb-2">
                       <span className="text-[10px] font-black uppercase tracking-widest text-zinc-500">Critical Area</span>
                       <span className="text-sm font-black text-rose-500">{data.overview.weakest_subject}</span>
                    </div>
                 </div>
              )}
           </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
         {/* Detailed Metrics */}
         <Card className="border shadow-md rounded-2xl p-6 bg-white dark:bg-zinc-950 flex flex-col items-center gap-6">
            <div className="h-16 w-16 rounded-2xl bg-orange-50 dark:bg-orange-900/20 flex items-center justify-center">
               <TrendingUp className="h-8 w-8 text-orange-500" />
            </div>
            <div className="text-center">
               <h4 className="text-sm font-black uppercase tracking-widest">Tests Taken</h4>
               <p className="text-3xl font-black mt-1">{data?.overview.total_tests_taken || 0}</p>
         ...
         <Card className="border shadow-md rounded-2xl p-6 bg-white dark:bg-zinc-950 flex flex-col items-center gap-6">
            ...
            <div className="text-center">
               <h4 className="text-sm font-black uppercase tracking-widest">Avg Accuracy</h4>
               <p className="text-3xl font-black mt-1">{data?.overview.average_score || 0}%</p>
         ...
         <Card className="border shadow-md rounded-2xl p-6 bg-white dark:bg-zinc-950 flex flex-col items-center gap-6">
            ...
            <div className="text-center">
               <h4 className="text-sm font-black uppercase tracking-widest">Stability Index</h4>
               <p className="text-3xl font-black mt-1">{data ? (data.overview.average_score > 70 ? 'High' : 'Medium') : 'N/A'}</p>
      ...
      <Card className="border shadow-md rounded-2xl bg-black text-white p-10 relative overflow-hidden group">
         <div className="relative z-10 flex flex-col lg:flex-row justify-between items-center gap-12">
            <div className="max-w-2xl space-y-6">
               ...
               <Button size="sm" className="bg-white text-black font-black px-8 h-12 rounded-xl group-hover:scale-105 transition-all">
            ...
            <div className="flex gap-4">
               {[
                  ...
                  <div key={i} className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-2xl text-center min-w-[140px]">
