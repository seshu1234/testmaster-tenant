...
<div class="col-xs-12 c-test-instructions" style="font-family: Arial, sans-serif; line-height: 1.5; color: #333;">
  <div class="row">
    <div class="col-xs-12 dynamic-instructions">
      <h3 class="text-center font-bold text-xl mb-4">Exam Specific Instructions</h3>
      <div class="di-content">
        ...
        <div class="for-ssc mt-6 border-t pt-4">
          ...
          11) परीक्षा की अवधि पूर्ण होने पर, यदि अभ्‍यर्थी उत्‍तर पर क्लिक नहीं करता है अथवा <span class="bg-green-100 text-green-800 px-1 border border-green-300 rounded">Submit Test</span> बटन पर क्लिक नहीं करता है तो कंप्‍यूटर द्वारा स्‍वत: शून्‍य परिणाम सहेज लिया जाएगा । (Auto submit on time up).<br><br>
          <div align="center" class="font-bold text-lg my-4">"ALL THE BEST"</div>
        </div>
      </div>
    </div>
  </div>
